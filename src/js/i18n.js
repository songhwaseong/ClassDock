...
(function () {
  ...
  var DICT = {
    ...
    "그림 칸에 꼭 맞게 사진 넣기": "Add a photo that fits the picture box",
    ...
    "붙인 사진 — 끌어서 옮기기, 모서리로 크기, 위 손잡이로 돌리기, 우클릭으로 순서·뒤집기": "Photo sticker — drag to move, corner to resize, top handle to rotate, right-click for order and flip",
    "크기 바꾸기": "Resize",
    ...
    "글 맞춤": "Text alignment",
    "색 바꾸기": "Change color",
    "색을 먼저 고르면 그 색으로 붙어요.": "Pick a color first and new stickers use it.",
