...
(function () {
  ...
  var DICT = {
    ...
    "이 폴더는 원본 쓰기 권한 없이 열려 자동 저장 폴더에 저장했어요. 원본에 저장하려면 '폴더 열기'로 다시 여세요.": "This folder was opened without permission to write to the original, so the file was saved in the auto-save folder. To save to the original, reopen it with Open Folder.",
    "이 폴더는 원본 쓰기 권한 없이 열려 선택한 위치에 별도 파일로 저장했어요. 원본에 저장하려면 '폴더 열기'로 다시 여세요.": "This folder was opened without permission to write to the original, so a separate file was saved in the selected location. To save to the original, reopen it with Open Folder.",
    "이 폴더는 원본 쓰기 권한 없이 열려 다운로드 사본으로 저장했어요. 원본에 저장하려면 '폴더 열기'로 다시 여세요.": "This folder was opened without permission to write to the original, so a downloaded copy was saved. To save to the original, reopen it with Open Folder.",
