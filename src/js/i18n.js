...
(function () {
  ...
  var DICT = {
    ...
    "출처: 제주 버스정보시스템": "Source: Jeju Bus Information System",
    ...
    "제주 사이트에 노선번호를 하나씩 물어 목록을 새로 만듭니다.": "This asks the Jeju site for one route number at a time to rebuild the list.",
    "약": "About",
    "분 걸리고, 요청을": " minutes, sending",
    "번 보냅니다. 도중에 멈출 수 있어요.": " requests. You can stop it while it runs.",
