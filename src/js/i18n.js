...
(function () {
  ...
  var DICT = {
    ...
    "항공 운항": "Flights",
    "공항": "Airport",
    "출발·도착": "Departures or arrivals",
    "국내선·국제선": "Domestic or international",
    "국내선": "Domestic",
    "국제선": "International",
    "게시판 보기": "Show board",
    "끝난 편 숨기기": "Hide finished flights",
    "전체 보기": "Fit all",
    "지도에서 지우기": "Clear from map",
    "편명 (예: KE1201)": "Flight no. (e.g. KE1201)",
    "편명": "Flight",
    "편명 찾기": "Find flight",
    "비행기의 실시간 위치가 아니라 공항 운항 게시판이에요. 선은 두 공항을 곧게 이은 그림입니다.": "This is the airport flight board, not live aircraft positions. Lines simply connect the two airports.",
    "출처: 한국공항공사(공공데이터포털)": "Source: Korea Airports Corporation (data.go.kr)",
    ...
    "끝난 편": "Finished",
    "편 숨김": " hidden",
    "위치를 모르는 공항": "Airports without a location:",
    "곳은 목록에만": " (list only)",
    "일부만 받음": "Partial list",
    "남은 편이 없어요. '끝난 편 숨기기'를 끄면 오늘 편을 모두 봅니다.": "No flights left. Turn off 'Hide finished flights' to see all of today's flights.",
    "보여 줄 편이 없어요.": "No flights to show.",
    "운항 게시판을 받는 중…": "Loading the flight board…",
    "몇 분마다 새로 받아요.": "Updates every few minutes.",
    "운항 정보를 받지 못했어요. 잠시 후 다시 시도해 주세요.": "Could not load flight information. Try again shortly.",
    "편명을 입력해 주세요. (예: KE1201)": "Enter a flight number (e.g. KE1201).",
    "편명을 찾는 중…": "Searching for the flight…",
    "오늘 운항 게시판에서 이 편명을 찾지 못했어요.": "This flight is not on today's boards.",
    "편명을 찾지 못했어요. 잠시 후 다시 시도해 주세요.": "Could not search for the flight. Try again shortly.",
    "항공 운항 표시를 지웠어요.": "Flight display cleared.",
    "공항 운항 게시판을 지도에 노선으로 펼칩니다.": "Shows an airport's flight board as routes on the map.",
    "인증키가 편명 찾기에 쓰일 수 없어요. 공공데이터포털에서 '한국공항공사_실시간 항공기 운항정보 검색' 활용신청을 확인해 주세요. 승인 직후라면 반영까지 시간이 걸릴 수 있어요.": "The service key can't be used for flight search. Check your data.go.kr application for 'KAC real-time flight information search'. It can take a while right after approval.",
    "인증키가 항공 운항 조회에 쓰일 수 없어요. 공공데이터포털에서 '한국공항공사_실시간 항공기 운항정보 조회' 활용신청을 확인해 주세요. 승인 직후라면 반영까지 시간이 걸릴 수 있어요.": "The service key can't be used for flight boards. Check your data.go.kr application for 'KAC real-time flight information'. It can take a while right after approval.",
    // NEIS 교육정보 — 일기장 '우리 학교'·설정 연결 탭
    "학교 정보를 찾지 못했어요.": "Couldn't find the school details.",
    "우리 학교 — 급식·학사일정·시간표": "My school — lunch menu, school calendar, timetable",
    "학교 정보를 받는 중…": "Loading school information…",
    "일기에 넣기": "Add to diary",
    "급식 메뉴를 일기 끝에 한 줄로 넣기": "Add the lunch menu as a line at the end of the diary",
    "급식 정보가 없어요": "No lunch menu",
    "학년·반을 고르면 시간표가 보여요": "Choose a grade and class to see the timetable",
    "시간표가 없어요": "No timetable",
    "NEIS 인증키가 없어 일부(5줄)만 보여요. 설정 → 연결에서 'NEIS 교육정보' 키를 넣어 주세요.": "Without a NEIS key only part (5 rows) is shown. Add the 'NEIS education' key in Settings → Connections.",
    "아직 고른 학교가 없어요": "No school chosen yet",
    "학교 이름 (예: 가락초)": "School name (e.g. 가락초)",
    "학교 찾기": "Find school",
    "학교 빼기": "Remove school",
    "고른 학교를 지우기": "Forget the chosen school",
    "학교를 찾는 중…": "Searching schools…",
    "찾은 학교가 없어요. 이름 일부로 다시 찾아 보세요.": "No school found. Try part of the name.",
    "NEIS 인증키가 없어 앞의 5곳만 보여요.": "Without a NEIS key only the first 5 schools are shown.",
    "NEIS가 인증키를 받지 않았어요. 설정 → 연결의 'NEIS 교육정보'를 확인해 주세요.": "NEIS rejected the key. Check 'NEIS education' in Settings → Connections.",
    "NEIS 조회 한도를 넘었어요. 내일 다시 이용해 주세요.": "NEIS request limit reached. Please try again tomorrow.",
    "NEIS에 물을 수 없는 조합이에요.": "NEIS can't answer that request.",
    "NEIS에서 받지 못했어요. 인터넷 연결을 확인해 주세요.": "Couldn't get data from NEIS. Check the internet connection.",
    "NEIS 교육정보": "NEIS education",
    "NEIS 인증키": "NEIS key",
    "NEIS 인증키가 이 Windows 사용자 계정에 암호화되어 있습니다.": "The NEIS key is encrypted for this Windows user account.",
    "NEIS 인증키를 암호화하여 저장하지 못했습니다.": "Couldn't save the NEIS key encrypted.",
    "NEIS 인증키를 이번 실행 동안 기억하고 있습니다.": "The NEIS key is kept for this session only.",
    "NEIS 인증키를 저장하는 중…": "Saving the NEIS key…",
    "NEIS 인증키를 저장했고 연결을 확인했습니다.": "NEIS key saved and the connection works.",
    "NEIS 인증키를 지웠습니다.": "NEIS key removed.",
    "NEIS 조회 한도를 넘었습니다. 잠시 후 다시 시도해 주세요.": "NEIS request limit reached. Please try again later.",
    "NEIS 키 설정은 ClassDock.exe에서 사용할 수 있습니다.": "NEIS key settings are available in ClassDock.exe.",
    "NEIS가 이 인증키를 받지 않았습니다. 나이스 포털 마이페이지의 키를 그대로 붙여 넣었는지 확인해 주세요.": "NEIS rejected this key. Make sure you pasted the key exactly as shown on the NEIS portal's My Page.",
    "NEIS에 연결해 보는 중…": "Testing the NEIS connection…",
    "인증키 형식이 올바르지 않습니다. 나이스 포털에서 받은 키를 그대로 붙여 넣어 주세요.": "The key format is not valid. Paste the key exactly as the NEIS portal issued it.",
    "인증키가 없어 일기장 '우리 학교'는 한 번에 5줄까지만 보입니다.": "Without a key, the diary's 'My school' shows at most 5 rows at a time.",
    "일기장의 '우리 학교'(급식·학사일정·시간표)에 씁니다. 나이스 교육정보 개방 포털(open.neis.go.kr)에서 무료로 발급받습니다. 키가 없어도 한 번에 5줄까지는 볼 수 있습니다.": "Used by the diary's 'My school' (lunch menu, school calendar, timetable). Get a free key from the NEIS open portal (open.neis.go.kr). Without a key you can still see up to 5 rows at a time.",
    "저장할 NEIS 인증키를 입력해 주세요.": "Enter the NEIS key to save.",
    "키는 저장했지만 NEIS에 연결하지 못했습니다. 인터넷 연결을 확인해 주세요.": "The key was saved, but NEIS couldn't be reached. Check the internet connection.",
    // KOSIS 국가통계 — 색칠 지도 가져오기·설정 연결 탭
    "자주 쓰는 통계": "Common statistics",
    "검색해서 고르기": "Search KOSIS",
    "예: 도서관, 학생 수, 쌀 생산량": "e.g. libraries, students, rice production",
    "KOSIS 통계표 찾기": "Search KOSIS tables",
    "출처: KOSIS 국가통계포털": "Source: KOSIS (Statistics Korea)",
    "지역으로 나눈 값이 없어요. 다른 항목이나 해를 골라 주세요.": "No values by region. Choose another item or year.",
    "이 통계는 시도까지만 있어 기준을 '시도'로 바꿨어요.": "This statistic only goes down to provinces, so the level was switched to provinces.",
    "이 통계는 시군구 값이라 기준을 '시군구'로 바꿨어요.": "This statistic is by district, so the level was switched to districts.",
    "가져왔어요 — 아래에서 색을 고르고 [칠하기]를 누르세요.": "Imported — choose colors below and press [Apply colors].",
    "시도별로만 있는 통계예요.": "Available by province only.",
    "KOSIS에서 받는 중…": "Getting data from KOSIS…",
    "그 해 자료가 아직 없어요. 다른 해를 골라 주세요.": "No data for that year yet. Choose another year.",
    "자료가 없어요.": "No data.",
    "KOSIS에서 찾는 중…": "Searching KOSIS…",
    "표를 고르세요. 제목에 '시도'·'시군구'가 든 표가 색칠 지도에 맞아요.": "Pick a table. Tables with 시도 (province) or 시군구 (district) in the title fit the choropleth.",
    "찾은 통계표가 없어요. 다른 낱말로 찾아 보세요.": "No tables found. Try other words.",
    "통계표 정보를 받는 중…": "Getting table details…",
    "이 표는 지역으로 나뉘어 있지 않아요. 다른 표를 골라 주세요.": "This table is not broken down by region. Choose another table.",
    "이 표에서 값 항목을 찾지 못했어요.": "Couldn't find a value item in this table.",
    "설정 → 연결의 'KOSIS 국가통계'에 인증키를 넣어 주세요.": "Enter your KOSIS key in Settings → Connections.",
    "KOSIS가 인증키를 받지 않았어요. 설정 → 연결에서 키를 끝의 '=' 까지 통째로 다시 넣어 주세요.": "KOSIS rejected the key. Re-enter the whole key (including any trailing '=') in Settings → Connections.",
    "KOSIS 조회 한도를 넘었어요. 잠시 후 다시 시도해 주세요.": "KOSIS request limit reached. Please try again later.",
    "자료가 너무 많아요(KOSIS 한 번에 4만 칸). 분류를 좁혀 주세요.": "Too much data (KOSIS allows 40,000 cells per request). Narrow the categories.",
    "KOSIS에 물을 수 없는 조합이에요. 다른 항목이나 해를 골라 주세요.": "KOSIS can't answer that combination. Choose another item or year.",
    "KOSIS에서 자료를 받지 못했어요. 인터넷 연결을 확인하고 다시 시도해 주세요.": "Couldn't get data from KOSIS. Check the internet connection and try again.",
    "KOSIS 국가통계": "KOSIS statistics",
    "지도 색칠 지도의 'KOSIS에서 가져오기'에 필요합니다. KOSIS 공유서비스(kosis.kr/openapi)에서 무료로 발급받습니다. 공공데이터포털 키와는 다른 키이며, 끝의 '=' 까지 통째로 붙여 넣어 주세요.": "Needed for 'Import from KOSIS' in the map choropleth. Get a free key from the KOSIS sharing service (kosis.kr/openapi). It is different from the data.go.kr key; paste the whole key, including any trailing '='.",
    "KOSIS 인증키": "KOSIS key",
    "KOSIS 인증키가 이 Windows 사용자 계정에 암호화되어 있습니다.": "The KOSIS key is encrypted for this Windows user account.",
    "KOSIS 인증키를 이번 실행 동안 기억하고 있습니다.": "The KOSIS key is kept for this session only.",
    "인증키가 없어 색칠 지도에서 KOSIS 통계를 가져올 수 없습니다.": "Without a key, the choropleth can't import KOSIS statistics.",
    "KOSIS 키 설정은 ClassDock.exe에서 사용할 수 있습니다.": "KOSIS key settings are available in ClassDock.exe.",
    "저장할 KOSIS 인증키를 입력해 주세요.": "Enter the KOSIS key to save.",
    "KOSIS 인증키를 저장하는 중…": "Saving the KOSIS key…",
    "KOSIS에 연결해 보는 중…": "Testing the KOSIS connection…",
    "KOSIS 인증키를 저장했고 연결을 확인했습니다.": "KOSIS key saved and the connection works.",
    "KOSIS가 이 인증키를 받지 않았습니다. 키를 통째로(끝의 '=' 까지) 붙여 넣었는지 확인해 주세요.": "KOSIS rejected this key. Make sure you pasted the whole key (including any trailing '=').",
    "KOSIS 조회 한도를 넘었습니다. 잠시 후 다시 시도해 주세요.": "KOSIS request limit reached. Please try again later.",
    "키는 저장했지만 KOSIS에 연결하지 못했습니다. 인터넷 연결을 확인해 주세요.": "The key was saved, but KOSIS couldn't be reached. Check the internet connection.",
    "KOSIS 인증키를 암호화하여 저장하지 못했습니다.": "Couldn't save the KOSIS key encrypted.",
    "인증키 형식이 올바르지 않습니다. KOSIS에서 받은 키를 그대로 붙여 넣어 주세요.": "The key format is not valid. Paste the key exactly as KOSIS issued it.",
    "KOSIS 인증키를 지웠습니다.": "KOSIS key removed.",
    "KOSIS에서 가져오기": "Import from KOSIS",
    "KOSIS 국가통계포털에서 시도·시군구 통계를 받아 표에 채웁니다": "Fill the table with province/district statistics from KOSIS",
    // 날씨·특일(기상청·한국천문연구원) — 지도 날씨 패널·일기장 날씨 채우기
    "지도 가운데 날씨": "Weather at map center",
    "전국 주요 도시": "Major cities",
    "기상청 동네예보 격자(5km) 값이에요. 실황은 한 시간마다, 예보는 세 시간마다 새로 발표됩니다.": "Values are for the KMA 5 km forecast grid. Observations update hourly and forecasts every three hours.",
    "출처: 기상청(공공데이터포털)": "Source: Korea Meteorological Administration (data.go.kr)",
    "지금 날씨를 받지 못했어요.": "Couldn't get the current weather.",
    "전국 주요 도시 날씨를 받는 중…": "Getting weather for major cities…",
    "일부 도시는 받지 못했어요.": "Some cities could not be loaded.",
    "날씨 표시를 지웠어요.": "Weather cleared from the map.",
    "기상청 날씨(지금·예보)를 지도에서 봅니다.": "Show KMA weather (now and forecast) on the map.",
    "기상청 날씨를 받는 중…": "Getting KMA weather…",
    "설정 → 연결의 '공공데이터포털'에 인증키를 넣어 주세요.": "Enter your data.go.kr key in Settings → Connections.",
    "인증키가 날씨 조회에 쓰일 수 없어요. 공공데이터포털에서 '기상청_단기예보 조회서비스' 활용신청을 확인해 주세요. 승인 직후라면 반영까지 1~2시간 걸릴 수 있어요.": "This key can't be used for weather. Check your data.go.kr application for the KMA short-term forecast service (기상청_단기예보 조회서비스). New approvals can take 1–2 hours to take effect.",
    "인증키가 지난 날씨 조회에 쓰일 수 없어요. 공공데이터포털에서 '기상청_지상(종관, ASOS) 일자료 조회서비스' 활용신청을 확인해 주세요. 승인 직후라면 반영까지 1~2시간 걸릴 수 있어요.": "This key can't be used for past weather. Check your data.go.kr application for the KMA ASOS daily data service (기상청_지상(종관, ASOS) 일자료 조회서비스). New approvals can take 1–2 hours to take effect.",
    "인증키가 공휴일 조회에 쓰일 수 없어요. 공공데이터포털에서 '한국천문연구원_특일 정보' 활용신청을 확인해 주세요. 승인 직후라면 반영까지 1~2시간 걸릴 수 있어요.": "This key can't be used for public holidays. Check your data.go.kr application for the KASI special days service (한국천문연구원_특일 정보). New approvals can take 1–2 hours to take effect.",
    "기상청 예보 범위(대한민국) 밖이에요.": "This place is outside the KMA forecast area (South Korea).",
    "그날 관측 자료가 없어요.": "There is no observation for that day.",
    "날씨를 받지 못했어요. 잠시 후 다시 시도해 주세요.": "Couldn't get the weather. Please try again shortly.",
    "기상청 예보에 아직 이 날이 없어요.": "The KMA forecast doesn't cover this day yet.",
    "{place} 관측": "Observed at {place}",
    "최고 {max}°": "High {max}°",
    "최저 {min}°": "Low {min}°",
    "비 {mm}mm": "Rain {mm}mm",
    "{place} 지금": "{place} now",
    "기온 {t}°": "{t}°",
    "{place} 예보": "{place} forecast",
    "강수확률 {p}%": "Chance of rain {p}%",
    "기상청 자료로 날씨를 정하지 못했어요.": "Couldn't decide the weather from KMA data.",
    "날씨 지역": "Weather area",
    ...
    "출발 항구": "Departure port",
    "출발 항구 (예: 목포)": "Departure port (e.g. 목포)",
    "시간표 보기": "Show timetable",
    "지난 편 숨기기": "Hide past sailings",
    "내일": "Tomorrow",
    "📍 지도 가운데 근처 항구": "📍 Ports near map center",
    "지도 가운데 근처에 아는 항구가 없어요.": "No known ports near the map center.",
    "도착지": "Destinations",
    "지난 편": "Past",
    "위치를 모르는 곳": "Places without a location:",
    "배 이름 없음": "Unnamed ship",
    "항구 위치": "Port locations",
    "배의 실시간 위치나 결항 소식이 아니라 운항 시간표예요. 점선은 두 항구를 곧게 이은 그림이고 실제 뱃길과 다릅니다. 기상에 따라 결항될 수 있으니 떠나기 전에 선사에 확인하세요.": "This is a timetable, not live ship positions or cancellation news. Dashed lines simply connect the two ports and are not the real sea route. Sailings can be cancelled due to weather — check with the operator before you go.",
    "출처: 국가대중교통정보센터(TAGO) · 항구 위치: © OpenStreetMap": "Source: TAGO (Korea transit info) · Port locations: © OpenStreetMap",
    "오늘 남은 편이 없어요. '지난 편 숨기기'를 끄면 오늘 편을 모두 봅니다.": "No sailings left today. Turn off 'Hide past sailings' to see all of today's sailings.",
    "이 날 이 항구에서 떠나는 여객선이 없어요.": "No ferries leave this port on this day.",
    "항구 목록을 받는 중이에요. 잠시 뒤 다시 눌러 주세요.": "Loading the port list. Try again in a moment.",
    "항구 이름을 목록에서 골라 주세요. (예: 목포, 인천, 통영, 완도_화흥포)": "Pick a port name from the list (e.g. 목포, 인천, 통영, 완도_화흥포).",
    "시간표를 받는 중…": "Loading the timetable…",
    "시간표를 받지 못했어요. 잠시 후 다시 시도해 주세요.": "Could not load the timetable. Try again shortly.",
    "여객선 표시를 지웠어요.": "Ferry display cleared.",
    "항구 목록을 받지 못했어요. 잠시 후 다시 열어 주세요.": "Could not load the port list. Reopen the panel shortly.",
    "항구의 여객선 시간표를 지도에 뱃길 선으로 펼칩니다.": "Shows a port's ferry timetable as routes on the map.",
    "인증키가 여객선 시간표에 쓰일 수 없어요. 공공데이터포털에서 '국토교통부_(TAGO)_국내선박운항정보' 활용신청을 확인해 주세요. 승인 직후라면 반영까지 시간이 걸릴 수 있어요.": "The service key can't be used for ferry timetables. Check your data.go.kr application for 'MOLIT (TAGO) domestic ship operation info'. It can take a while right after approval.",
    // 버스 실시간 지도(TAGO, 전국 도시)
    "버스 표시 끄기": "Turn off buses",
    "🚌 버스": "🚌 Buses",
    "도시": "City",
    "제주": "Jeju",
    "노선번호": "Route number",
    "노선번호를 입력해 주세요.": "Enter a route number.",
    "버스 노선을 선택해 실시간 위치를 봅니다.": "Select a bus route to see live positions.",
    "버스 표시를 껐어요.": "Bus display is off.",
    "버스 위치": "Bus positions",
    "노선 목록 없음 · 목록 최신화로 받기": "No route list · Get one with Update list",
    "이 도시는 노선 목록이 아직 없어요": "No route list for this city yet",
    "TAGO에서 노선 목록을 받아 새로 만듭니다.": "This rebuilds the route list from TAGO.",
    "📍 지도 가운데 근처 정류장": "📍 Stops near map center",
    "근처 정류장을 찾는 중…": "Finding nearby stops…",
    "지도 가운데 근처에 정류장이 없어요. 지도를 옮겨 다시 찾아 주세요.": "No stops near the map center. Move the map and try again.",
    "근처 정류장을 받지 못했어요. 잠시 후 다시 찾아 주세요.": "Could not load nearby stops. Try again shortly.",
    "새로고침": "Refresh",
    "도착 정보를 받는 중…": "Loading arrivals…",
    "도착 정보를 받지 못했어요. 잠시 후 새로고침해 주세요.": "Could not load arrivals. Refresh shortly.",
    "지금 이 정류장으로 오는 버스 정보가 없어요.": "No buses are currently reported for this stop.",
    "수신": "Received",
    "곧 도착": "Arriving soon",
    "분 후": " min",
    "정류장 전": " stops away",
    "도착 정보 없음": "No arrival info",
    "이 노선을 검색합니다.": "Search this route.",
    "인증키가 버스 도착 정보에 쓰일 수 없어요. 공공데이터포털에서 TAGO 버스도착정보 활용신청을 확인해 주세요. 승인 직후라면 반영까지 시간이 걸릴 수 있어요.": "The service key was rejected for bus arrivals. Check on data.go.kr that it is approved for TAGO bus arrival information. New approvals can take a while to take effect.",
    "인증키가 정류장 찾기에 쓰일 수 없어요. 공공데이터포털에서 TAGO 버스정류소정보 활용신청을 확인해 주세요. 승인 직후라면 반영까지 시간이 걸릴 수 있어요.": "The service key was rejected for finding stops. Check on data.go.kr that it is approved for TAGO bus stop information. New approvals can take a while to take effect.",
    "제주 버스 표시 끄기": "Turn off Jeju buses",
    "🚌 제주 버스": "🚌 Jeju buses",
    "제주 버스": "Jeju buses",
    "ClassDock EXE에서 인터넷 연결 후 사용할 수 있어요.": "Available in ClassDock EXE with an internet connection.",
    "노선번호 (예: 201)": "Route number (e.g. 201)",
    "버스 노선번호": "Bus route number",
    "버스 세부 노선": "Bus route variant",
    "노선을 검색해 주세요.": "Search for a route.",
    "지도에 표시": "Show on map",
    "끄기": "Turn off",
    "노선 전체 보기": "Show entire route",
    ...
    "버스": "Buses",
    "대": " vehicles",
    "버스 정보를 받는 중…": "Loading bus positions…",
    "정보 수신 지연": "Data reception delayed",
    "현재 조회된 차량 없음": "No vehicles returned",
    "버스 정보를 받지 못했어요. 다시 시도하는 중이에요.": "Could not load bus positions. Retrying.",
    "정류장 목록을 받는 중…": "Loading stops…",
    "정류장 정보를 받지 못했어요. 노선을 새로고침해 주세요.": "Could not load stops. Refresh the route.",
    "노선번호를 입력해 주세요. (예: 201)": "Enter a route number (e.g. 201).",
    "노선을 검색하는 중…": "Searching routes…",
    "세부 경로": "Variant",
    "검색된 노선이 없어요.": "No matching routes.",
    "노선을 받지 못했어요. 잠시 후 다시 검색해 주세요.": "Could not load routes. Try again shortly.",
    "제주 버스 노선을 선택해 실시간 위치를 봅니다.": "Select a Jeju bus route to see live positions.",
    "노선 목록에서 고르기": "Pick from the route list",
    "번대": "s",
    "기타 번호": "Other numbers",
    "목록 최신화": "Update list",
    "최신화 취소": "Stop update",
    "앱에 들어 있는 노선 목록": "Built-in route list",
    "최신화한 노선 목록": "Updated route list",
    "개 번호": " numbers",
    "노선 목록 최신화 중": "Updating route list",
    "찾은 번호": "Numbers found",
    "노선 목록을 최신화했어요.": "Route list updated.",
    "최신화를 멈췄어요. 예전 목록을 그대로 씁니다.": "Update stopped. Keeping the previous list.",
    "사이트가 요청을 거절해 멈췄어요. 예전 목록을 그대로 씁니다.": "The site refused the requests, so the update stopped. Keeping the previous list.",
    "찾은 번호가 너무 적어 예전 목록을 그대로 씁니다.": "Too few numbers were found. Keeping the previous list.",
    "노선 목록을 받지 못했어요. 예전 목록을 그대로 씁니다.": "Could not load the route list. Keeping the previous list.",
    "노선 목록 최신화를 시작하지 못했어요.": "Could not start the route list update.",
    "TAGO에서 제주 노선 목록을 받아 새로 만듭니다.": "This rebuilds the Jeju route list from TAGO.",
    "오늘 조회 한도에서 요청을 약": "It uses about",
    "번 씁니다. 도중에 멈출 수 있어요.": " requests from today's quota. You can stop it while it runs.",
    "설정의 '공공데이터포털'에 인증키를 넣어 주세요.": "Enter a service key under 'Data.go.kr' in Settings.",
    "인증키가 이 조회에 쓰일 수 없어요. 공공데이터포털에서 TAGO 버스노선정보·버스위치정보 활용신청을 확인해 주세요. 승인 직후라면 반영까지 시간이 걸릴 수 있어요.": "The service key was rejected for this request. Check on data.go.kr that it is approved for both TAGO bus route and bus location information. New approvals can take a while to take effect.",
    "오늘 조회 한도를 다 썼어요. 내일 다시 이용해 주세요.": "Today's request quota is used up. Try again tomorrow.",
    "공공데이터포털 인증키가 없거나 맞지 않아요. 예전 목록을 그대로 씁니다.": "The data.go.kr service key is missing or was rejected. Keeping the previous list.",
    "오늘 조회 한도를 다 썼어요. 예전 목록을 그대로 씁니다.": "Today's request quota is used up. Keeping the previous list.",
    "정류장 정보가 없어요.": "No stop information.",
    "공공데이터포털": "Data.go.kr",
    "공공데이터포털 인증키": "data.go.kr service key",
    "인증키가 없어 지도의 '제주 버스'를 쓸 수 없습니다.": "Without a key, 'Jeju buses' on the map is unavailable.",
    "인증키가 없어 지도에서 버스·항공 운항·여객선을 쓸 수 없습니다.": "Without a key, buses, flights, and ferries are unavailable on maps.",
    "공공데이터포털 인증키가 이 Windows 사용자 계정에 암호화되어 있습니다.": "The data.go.kr service key is stored encrypted for this Windows user.",
    "공공데이터포털 인증키를 이번 실행 동안 기억하고 있습니다.": "The data.go.kr service key is kept for this session only.",
    "공공데이터포털 키 설정은 ClassDock.exe에서 사용할 수 있습니다.": "Data.go.kr key settings are available in ClassDock.exe.",
    "저장할 공공데이터포털 인증키를 입력해 주세요.": "Enter the data.go.kr service key to save.",
    "공공데이터포털 인증키를 저장하는 중…": "Saving the data.go.kr service key…",
    "공공데이터포털 인증키를 저장했습니다. 기능마다 필요한 서비스를 별도로 활용신청해야 합니다.": "Saved the data.go.kr service key. Each feature still requires its corresponding service application.",
    "공공데이터포털 인증키를 암호화하여 저장하지 못했습니다.": "Could not store the data.go.kr service key securely.",
    "인증키 형식이 올바르지 않습니다. 공공데이터포털의 일반 인증키를 그대로 붙여 넣어 주세요.": "The key format is invalid. Paste the general service key from data.go.kr as issued.",
    "공공데이터포털 인증키를 지웠습니다.": "Removed the data.go.kr service key.",
    "제주 버스 위치": "Jeju bus positions",
    "차량 정보 갱신 대기": "Waiting for vehicle update",
    "정류장 정보 갱신 · 위치 갱신 대기": "Stop updated · Waiting for position update",
    "위치 변화 확인 안 됨": "No position change observed",
    "마지막 수신 위치": "Last received position",
    // 지하철 역별 도착 정보
    "역 도착 정보": "Station arrivals",
    "{station} 도착 정보": "{station} arrivals",
    "{terminal}행": "To {terminal}",
    "기준 {time}": "As of {time}",
    ...
    "겹친 표시 {count}곳은 양쪽에 포함": "{count} shared places are counted in both areas",
    "차이 (B−A)": "Difference (B−A)",
    "A로 고정하고 비교": "Fix as A and compare",
    "비교 끝내기": "End comparison",
    "A는 고정, B는 끌거나 다른 곳을 우클릭해 이동합니다.": "A stays fixed. Drag B or right-click another location to move B.",
    "시설별 비교 · 같은 반경": "Places by category · Same radius",
    "비교표로 메모": "Comparison table to notes",
    "비교 차트로 칠판": "Comparison chart to board",
    "◎ {distance} · A {a} / B {b}곳 · 펼치기": "◎ {distance} · A {a} / B {b} places · Expand",
    "B 목록 보기": "Show B places",
    "B 장소를 메모로": "B places to notes",
    "A 주황 · B 청록 · 겹침 보라": "A orange · B teal · Shared purple",
    "A 고정 중심": "A fixed center",
    "B 중심을 끌어서 이동": "Drag to move center B",
    "비교표를 메모로 보냈어요. 표의 한도로 {count}행은 빠졌습니다.": "Sent the comparison table to notes. {count} rows were omitted due to the table limit.",
    "A·B 비교표를 메모로 보냈어요.": "Sent the A/B comparison table to notes.",
    "비교 차트를 칠판에 넣지 못했어요.": "Could not add the comparison chart to the board.",
    "전체 A {a}곳 / B {b}곳": "Total A {a} places / B {b} places",
    ...
    "◎ 반경 보기": "◎ Radius view",
    "반경 보기": "Radius view",
    "◎ 여기서 반경 보기": "◎ Show radius here",
    "이 지점을 중심으로 반경 안의 표시를 비교합니다": "Compare markers within a radius of this point",
    "직접 입력 (m)": "Custom radius (m)",
    "반경 미터 (100~50000)": "Radius in meters (100–50000)",
    "반경 안 표시 {count}곳": "{count} places within radius",
    "반경 안에 등록된 표시가 없어요.": "No registered markers within this radius.",
    "반경 지우기": "Remove radius",
    "지도에 넣은 표시 기준 · 직선 반경": "Based on visible registered markers · Straight-line radius",
    "반경 필터 해제": "Clear radius filter",
    "끌어서 중심 이동": "Drag to move the center",
    "반경 중심": "Radius center",
    "◎ {distance} · {count}곳 · 펼치기": "◎ {distance} · {count} places · Expand",
    "반경 보기 일시 중지 · 펼치기": "Radius view paused · Expand",
    "이미지 배경은 축척을 알 수 없어 반경 보기를 잠시 쉽니다.": "Radius view is paused because this image background has no calibrated scale.",
    "이미지 배경은 축척을 알 수 없어 반경 보기를 사용할 수 없습니다.": "Radius view requires a calibrated scale and is unavailable on image backgrounds.",
    "반경 보기 중에는 개별 장소를 보여 줍니다. 반경을 지우면 표시 묶기가 돌아옵니다.": "Radius view shows individual places. Clustering resumes when you remove the radius.",
    "반경 {distance} · 중심 {center}": "Radius {distance} · Center {center}",
    "중심에서 거리 (m)": "Distance from center (m)",
    "반경 표를 메모로 보냈어요. 표의 한도로 {count}곳은 빠졌습니다.": "Sent the radius table to notes. {count} places were omitted due to the table limit.",
    "반경 안 표시 {count}곳을 메모 표로 보냈어요.": "Sent {count} places within the radius to a note table.",
    "장소명": "Place name",
    "미분류": "Uncategorized",
    "공원": "Park",
    ...
    "일반 문서": "General documents",
    "수업 자료": "Class materials",
    "새 블록 문서(.mnote)": "New block document (.mnote)",
    "새 시험지 만들기(.exam)": "Create exam paper (.exam)",
    "새 코드": "New code",
    ...
    "지도 문서의 버스·항공 운항·여객선에 함께 쓰는 공공데이터포털 일반 인증키입니다. 키 하나를 저장한 뒤 공공데이터포털에서 필요한 서비스를 각각 활용신청해 주세요. 키 저장은 형식만 확인하며, 실제 사용 가능 여부와 조회 한도는 각 기능을 열 때 해당 서비스가 알려 줍니다. 인코딩·디코딩 키 모두 됩니다.":
      "The general data.go.kr service key shared by buses, flights, and ferries in map documents. Save one key, then apply separately on data.go.kr for each service you need. Saving checks only the key format; each feature reports its own access and quota when opened. Encoded and decoded keys are both accepted.",
    ...
    "↺ 검색 결과로": "↺ Back to results",
    "눌러 들어간 페이지에서 처음 검색 결과로 돌아가요": "Go back from the opened page to the first search results",
    "브라우저로 보기": "Open in browser",
    "결과가 안 보이거나 페이지가 비면, 같은 검색을 브라우저 창에서 열어요": "If results don't show or the page is blank, open the same search in a browser window",
    "Google 검색 창 닫기": "Close Google search",
    "Google 검색 결과": "Google search results",
    "결과가 안 보이거나 눌러 들어간 페이지가 비어 있으면 '브라우저로 보기'를 눌러 주세요.": "If results don't show or an opened page is blank, press 'Open in browser'.",
    "최근 검색어 (↓)": "Recent searches (↓)",
    "최근": "Recent",
    ...
    // 설정 → 단축키 (동적으로 만드는 목록)
    "악보 자판": "Score keyboard",
    "계이름과 자판 작곡 도구를 원하는 키로 설정합니다. 계이름 키는 따라치기·음감 테스트에도 함께 적용됩니다.": "Assign keys to note names and composing tools. Note-name keys are also shared with play-along practice and ear training.",
    "자판": "key",
    "음계 입력": "Notes",
    "옥타브": "Octave",
    "음표·쉼표": "Notes and rests",
    "임시표": "Accidentals",
    "악보 구조": "Score structure",
    "도": "Do",
    "도♯·레♭": "Do♯ · Re♭",
    "레": "Re",
    "레♯·미♭": "Re♯ · Mi♭",
    ...
    "옥타브 내림": "Octave down",
    "옥타브 올림": "Octave up",
    "자판 작곡 중 입력 음역 바꾸기": "Change the input octave while keyboard composing",
    "계이름 입력·연습 공통 키": "Shared note key for composing and practice",
    "온음표": "Whole note",
    "2분음표": "Half note",
    "4분음표": "Quarter note",
    "8분음표": "Eighth note",
    "16분음표": "Sixteenth note",
    "자판 작곡 중 음표 길이 선택": "Select note length while keyboard composing",
    "음표·쉼표 전환": "Toggle note/rest",
    "고른 길이의 음표와 쉼표 전환": "Toggle between notes and rests at the selected length",
    "점·겹점 전환": "Cycle dots",
    "점 없음·점·겹점을 차례로 전환": "Cycle through no dot, dot, and double dot",
    "내림표(♭)": "Flat (♭)",
    "제자리표(♮)": "Natural (♮)",
    "올림표(♯)": "Sharp (♯)",
    "다음 음 하나에 임시표 적용": "Apply an accidental to the next note",
    "마디 추가": "Add measure",
    "악보 끝에 빈 마디 추가": "Add an empty measure at the end",
    "오선 추가": "Add staff line",
    "악보 끝에 새 오선 한 단 추가": "Add a new staff line at the end",
    "자판 작곡에서 사용하는 키": "Key used while keyboard composing",
    ...
    // Java 실행 화면
    ".java 저장": "Save .java",
    "자바 파일 저장": "Save Java file",
    "자바 파일은 .java 확장자로 저장해야 해요.": "Java files must be saved with the .java extension.",
    ...
    "▶ 실행": "▶ Run",
    "결과 숨기기": "Hide output",
    "실행 결과 칸을 접고 편집기를 넓게 쓰기": "Hide the output pane and expand the editor",
    "편집한 내용을 버리고 원본 코드로 되돌릴까요?": "Discard your edits and restore the original code?",
    "이 컴퓨터에서 쓰는 자바(JDK) 확인": "Check the Java (JDK) used on this computer",
    "Java Env": "Java Env",
    "자바 실행 환경": "Java runtime environment",
    "실행 구성": "Run configuration",
    "현재 문서 기준": "Current document",
    "main 클래스": "Main class",
    "패키지": "Package",
    "함께 컴파일": "Compiled together",
    "현재 파일만": "Current file only",
    "선택 없음": "None selected",
    "실행 폴더": "Run folder",
    "찾지 못함": "Not found",
    "확인 중…": "Checking…",
    "JDK를 찾지 못함": "JDK not found",
    "ClassDock 임시 폴더 · 실행 후 자동 정리": "ClassDock temporary folder · removed after the run",
    "상세 컴파일 경고 사용 (-Xlint:all)": "Enable detailed compiler warnings (-Xlint:all)",
    "저장 검사·실행·채점에 같은 설정을 적용합니다.": "The same settings apply to save checks, runs, and grading.",
    "자바 보조 도구": "Java tools",
    "정상 종료 · 종료 코드 {code}": "Completed · exit code {code}",
    "컴파일 실패": "Compilation failed",
    "실행 중 오류 · 종료 코드 {code}": "Runtime error · exit code {code}",
    "JUnit": "JUnit",
    "JUnit 테스트 · 실행 중": "JUnit tests · running",
    "JUnit 테스트 중…": "Running JUnit tests…",
    "JUnit 테스트 통과": "JUnit tests passed",
    "JUnit 테스트 실패": "JUnit tests failed",
    "JUnit · 전체 {found}개 · 성공 {successful}개 · 실패 {failed}개 · 건너뜀 {skipped}개":
      "JUnit · {found} total · {successful} passed · {failed} failed · {skipped} skipped",
    "라이브러리에서 JUnit 5를 먼저 선택해 주세요.": "Select JUnit 5 in Library first.",
    "실행 중인 작업을 먼저 중지해 주세요.": "Stop the current run first.",
    "코드 정렬": "Format code",
    "import 정리": "Organize imports",
    "Java 코드 들여쓰기를 정리했습니다.": "Formatted Java indentation.",
    "정리할 들여쓰기 변화가 없습니다.": "Indentation is already formatted.",
    "import를 정리했습니다.": "Organized imports.",
    "정리할 import가 없습니다.": "Imports are already organized.",
    "JDK 사용 가능": "JDK available",
    "버전": "Version",
    "경로": "Path",
    "찾은 곳": "Detected from",
    "최소 버전": "Minimum version",
    "새 자바 코드": "New Java code",
    "따라치기": "Typing practice",
    "이 코드를 흐리게 두고 그 위에 똑같이 따라 쳐 보기 — 맞으면 제 색, 틀리면 빨강 (Esc: 그만두기)":
      "Type over a faint copy of this code — correct text keeps its color, mistakes turn red (Esc to stop)",
    "이 컴퓨터에서 자바(JDK)를 찾지 못했습니다": "Java (JDK) was not found on this computer",
    "자바 실행에는 PC에 설치된 JDK가 필요합니다. 아래 버튼을 누르면 이 컴퓨터에 한 번만 자동으로 설치합니다.":
      "Running Java requires a JDK installed on this PC. Use the button below to install it once on this computer.",
    "'자바 자동 설치'를 누르면 Eclipse Adoptium 공식 배포처에서 약 200MB를 내려받습니다(컴퓨터당 1회, 관리자 권한 불필요).":
      "'Install Java automatically' downloads about 200 MB from the official Eclipse Adoptium distribution (once per computer, no administrator access required).",
    "받은 파일은 배포처가 알려준 검증값과 대조한 뒤 설치하고, 끝나면 하던 실행을 이어갑니다.":
      "The download is verified against the publisher's checksum before installation, then your pending run continues.",
    "이미 JDK를 직접 설치했다면 '다시 검사'만 누르면 됩니다. JRE만 있으면 동작하지 않습니다.":
      "If you installed a JDK yourself, just select 'Scan again'. A JRE alone is not enough.",
    "자바 자동 설치": "Install Java automatically",
    "Eclipse Adoptium 공식 배포처에서 JDK를 내려받아 자동으로 설치해요 (컴퓨터당 1회)":
      "Download and install a JDK from the official Eclipse Adoptium distribution (once per computer)",
    "다시 검사": "Scan again",
    "이미 직접 설치했다면 이것만 누르면 됩니다": "Use this if you already installed a JDK yourself",
    "설치할 자바를 확인하는 중…": "Checking the Java version to install…",
    "자바 내려받는 중…": "Downloading Java…",
    "받은 파일 확인 중…": "Verifying the download…",
    "설치 중…": "Installing…",
    "설치 준비 중…": "Preparing installation…",
    "준비됐습니다. 이어서 실행합니다…": "Ready. Continuing your run…",
    "검사 중…": "Scanning…",
    "아직 찾지 못했습니다. JDK(JRE 아님) 설치를 마쳤는지 확인해 주세요.":
      "A JDK still wasn't found. Make sure you installed a JDK, not just a JRE.",
    "설치에 실패했습니다.": "Installation failed.",
    "시간이 너무 오래 걸립니다 — 인터넷 상태를 확인해 주세요.": "This is taking too long — check your internet connection.",
    "실행 결과 · 대화형 터미널": "Run output · interactive terminal",
    "값을 입력하고 Enter": "Enter a value and press Enter",
    "입력 끝": "End input",
    "표준입력을 닫습니다. hasNext() 로 끝까지 읽는 코드를 멈출 때 쓰세요":
      "Close standard input. Use this to finish code that reads until hasNext() returns false",
    "중지": "Stop",
    "↻ 재실행": "↻ Run again",
    "이 코드를 다시 실행": "Run this code again",
    "실행 종료": "Run finished",
    "…(출력이 길어 마지막 부분만 표시 중 — 전체는 실행이 끝나면 표시)":
      "…(output is long; showing only the latest part — all retained output appears when the run finishes)",
    "(출력 없음)": "(no output)",
    "채점을 중지했습니다.": "Grading stopped.",
    "현재 실행 중지": "Stop the current run",
    "중지하는 중…": "Stopping…",
    "채점 중…": "Grading…",
    "실행 중…": "Running…",
    "자바(JDK) 설치 필요": "Java (JDK) required",
    // Java 라이브러리(jar) 고르기
    "자바 라이브러리 추가": "Add Java libraries",
    "실행에 넣을 라이브러리": "Libraries for this run",
    "고른 항목은 이 문서의 실행·채점 클래스패스에 들어갑니다.": "Selected items join this document's run and grading classpath.",
    "라이브러리 목록을 확인할 수 있어요.": "You can review the library list here.",
    "라이브러리 목록을 읽는 중…": "Reading the library list…",
    "항목을 누르면 이 문서의 실행에 함께 들어갑니다.": "Select an item to include it in this document's run.",
    "라이브러리 추가는 ClassDock EXE에서만 사용할 수 있어요.": "Adding libraries is available only in the ClassDock EXE.",
    "쓸 수 있는 라이브러리가 없어요.": "No libraries are available.",
    "목록을 여는 중…": "Opening the list…",
    "아직 받지 않음": "Not downloaded yet",
    "라이브러리 검색 (예: lombok)": "Search libraries (for example, lombok)",
    "검색": "Search",
    "영문 라이브러리 이름으로 Maven Central을 검색할 수 있어요.": "Search Maven Central by an English library name.",
    "검색어는 영문 이름 2~80자로 적어 주세요.": "Enter an English library name using 2 to 80 characters.",
    "Maven Central을 검색하는 중…": "Searching Maven Central…",
    "추천 항목 {count}개를 먼저 표시했어요. Maven Central에서 추가 결과를 찾는 중…": "Showing {count} recommended item(s) now while Maven Central finds more…",
    "추천 항목만 표시했어요. Maven Central 추가 검색은 응답이 늦거나 연결되지 않았습니다.": "Showing recommended items only because the additional Maven Central search was slow or unavailable.",
    "최신 안정 버전과 의존성을 확인하는 중…": "Checking the latest stable version and dependencies…",
    "검색 결과가 없어요. 다른 이름으로 검색해 보세요.": "No results. Try another name.",
    "이미 받은 라이브러리를 이 문서에 적용했어요.": "Applied the already downloaded library to this document.",
    "라이브러리 검색은 ClassDock EXE에서만 사용할 수 있어요.": "Library search is available only in the ClassDock EXE.",
    "Maven Central에서 사용할 버전을 찾지 못했어요.": "No usable version was found in Maven Central.",
    "버전 확인 필요": "Version check required",
    "받기": "Get",
    "받는 중": "Downloading",
    "취소하는 중…": "Cancelling…",
    "작업을 시작합니다…": "Starting…",
    "실패": "Failed",
    "받기를 취소했어요.": "Download cancelled.",
    "받지 못했어요. 아래 기록을 확인해 주세요.": "Could not download it. Check the log below.",
    "라이브러리를 지웠어요.": "Library removed.",
    "라이브러리 설정을 저장할 공간이 부족해요.": "There is not enough space to save the library selection.",
    "group:artifact:version 형식으로 적어 주세요.": "Use the group:artifact:version format.",
    "이 문서의 실행에 함께 넣을 라이브러리 고르기": "Choose libraries to include in this document's run",
    "EXE에서만 쓸 수 있어요. jar 는 Maven Central에서 받아 배포처 검증값과 대조하며, 의존성이 딸린 라이브러리는 필요한 좌표를 하나씩 더 넣어야 합니다.":
      "Requires the EXE. Each jar comes from Maven Central and is checked against the publisher's checksum; a library with dependencies needs each coordinate added separately.",
    "코드 맨 위에 import 를 적어야 쓸 수 있어요. 항목을 누르면 예시 import 를 보여 줍니다.":
      "Add the import at the top of your code. Selecting an item shows an example import.",
    "과제 자동채점": "Assignment grading",
    ...
    "분할 완료": "Finish split",
    "터미널": "Terminal",
    "중복 줄 삭제": "Remove duplicate lines",
    "원본으로": "Revert",
    ...
    "실행 결과를 편집기 오른쪽 옆으로": "Move run output beside the editor",
    "실행 결과를 편집기 아래로": "Move run output below the editor",
    ...
    "새 악보(.msheet)": "New music score (.msheet)",
    "새 연대표 (.timeline)": "New timeline (.timeline)",
    "새 연대표(.timeline)": "New timeline (.timeline)",
    "새 개념 관계도 (.concept)": "New concept map (.concept)",
    "새 개념 관계도(.concept)": "New concept map (.concept)",
    ...
    "새 대진표(.bracket)": "New tournament bracket (.bracket)",
    "새 복불복 뽑기 (.pick)": "New random picker (.pick)",
    "새 복불복 뽑기(.pick)": "New random picker (.pick)",
    "+Pick 새 복불복 뽑기": "+Pick New random picker",
    ...
    "일기장 이름": "Diary name",
    "사진 붙이기": "Add photo",
    "사진을 스티커처럼 붙이기 — 종이 위로 끌어다 놓아도 돼요": "Stick a photo on the page — you can also drag one onto the paper",
    "꾸미기": "Decorate",
    "줄 무늬·배경 그림 바꾸기": "Change lines, font and background",
    "줄 무늬·일기장 바탕·배경 그림 바꾸기": "Change lines, diary background and paper image",
    "파일 암호 설정·변경": "Set or change file password",
    "암호로 보호됨 — 암호 변경·제거": "Password protected — change or remove password",
    "암호 설정": "Set password",
    "암호 변경": "Change password",
    "암호 제거": "Remove password",
    "일기장 암호": "Diary password",
    "일기장 암호 설정": "Set diary password",
    "일기장 암호 변경": "Change diary password",
    "암호로 보호된 일기장입니다. 내용과 사진을 보려면 암호를 입력하세요.": "This diary is password protected. Enter the password to view its entries and photos.",
    "암호 넣고 열기": "Enter password to open",
    "열기": "Open",
    "이 암호는 앱이나 파일에 저장하지 않습니다. 잊으면 일기와 사진을 복구할 수 없으니 기억할 수 있는 긴 암호를 사용하세요.":
      "This password is not stored in the app or file. If you forget it, the entries and photos cannot be recovered, so use a long password you can remember.",
    "암호를 확인하는 중…": "Checking password…",
    "암호화 키를 만드는 중…": "Creating encryption key…",
    "암호화하여 저장하는 중…": "Encrypting and saving…",
    "암호를 제거하여 저장하는 중…": "Removing password and saving…",
    "암호가 틀리거나 파일이 손상됐어요.": "The password is incorrect or the file is damaged.",
    "암호가 틀리거나 파일이 손상됐어요. 다시 입력해 주세요.": "The password is incorrect or the file is damaged. Try again.",
    "암호화된 일기장 형식을 읽지 못했어요.": "Couldn't read the encrypted diary format.",
    "이 화면에서는 일기장 암호 기능을 쓸 수 없어요. ClassDock EXE로 열어 주세요.": "Diary passwords aren't available here. Open the file in the ClassDock app.",
    "일기장 암호화에 실패했어요.": "Couldn't encrypt the diary.",
    "일기장 암호화에 실패해서 저장하지 못했어요.": "Couldn't save because diary encryption failed.",
    "저장이 끝난 뒤 다시 시도해 주세요.": "Try again after the current save finishes.",
    "새 암호로 일기장을 보호했어요.": "The diary is now protected with the new password.",
    "일기장을 암호로 보호했어요.": "The diary is now password protected.",
    "일기장 암호를 제거했어요.": "Removed the diary password.",
    "파일 암호를 제거할까요? 저장된 일기와 사진을 암호 없이 열 수 있게 됩니다.": "Remove the file password? The saved entries and photos will be readable without a password.",
    "인쇄": "Print",
    "인쇄·PDF로 저장 — 이 날·이번 달·일기장 전체": "Print or save as PDF — this day, this month, or the whole diary",
    "일기장 저장 (Ctrl+S)": "Save diary (Ctrl+S)",
    "● 저장 안 됨": "● Not saved",
    "달력": "Calendar",
    "달력·검색": "Calendar · Find",
    ...
    "즐겨찾기한 날": "Favorite day",
    "글감": "Prompts",
    "작성 질문과 양식 고르기": "Choose writing prompts and templates",
    "작성 질문과 양식": "Writing prompts and templates",
    "일기장이 잠겼어요": "Diary locked",
    "내용을 다시 보려면 파일 암호를 입력하세요.": "Enter the file password to view it again.",
    "잠금 풀기": "Unlock",
    "일기장 화면 잠금 풀기": "Unlock diary screen",
    "화면 잠금은 먼저 파일 암호를 설정해야 사용할 수 있어요.": "Set a file password before using screen lock.",
    "이전 달": "Previous month",
    "다음 달": "Next month",
    "오늘": "Today",
    "오늘 일기로 가기": "Go to today's entry",
    "전날 (Alt+PageUp)": "Previous day (Alt+PageUp)",
    "다음날 (Alt+PageDown)": "Next day (Alt+PageDown)",
    "제목(선택)": "Title (optional)",
    "이 날 일기 제목": "Title for this day",
    "이 날 일기 지우기": "Delete this day's entry",
    "일기 본문": "Diary text",
    "일기 있음": "Has entry",
    "이번 달엔 아직 일기가 없어요": "No entries this month yet",
    "꾸미기만 한 날": "Styled only",
    "오늘은 어떤 하루였나요?": "How was your day?",
    "이 날의 일기를 적어 보세요.": "Write about this day.",
    "날씨": "Weather",
    "기분": "Mood",
    "날씨 고르기": "Choose weather",
    "기분 고르기": "Choose mood",
    "그림 칸 — 사진을 넣거나(끌어다 놓아도 돼요) 직접 그려 보세요": "Picture box — add a photo (or drag one here), or draw your own",
    "그림 칸에 사진 넣기 — 여러 장이면 칸을 나눠 맞춰요": "Add photos to the picture box — several photos share the box",
    "그림 칸에 {n}장 나눠 맞추기": "Split the picture box between {n} photos",
    "사진 {n}장을 그림 칸에 나눠 맞췄어요.": "Fitted {n} photos into the picture box.",
    "스티커 {n}개를 그림 칸에 나눠 맞췄어요.": "Fitted {n} stickers into the picture box.",
    "스티커 {n}개를 줄 맞춰 깔았어요. Ctrl+Z 로 되돌릴 수 있어요.": "Laid out {n} stickers in rows. Press Ctrl+Z to undo.",
    "스티커 {n}개를 격자로 깔았어요. Ctrl+Z 로 되돌릴 수 있어요.": "Laid out {n} stickers in a grid. Press Ctrl+Z to undo.",
    "스티커 {n}개를 사진첩처럼 깔았어요. Ctrl+Z 로 되돌릴 수 있어요.": "Laid out {n} stickers like a photo album. Press Ctrl+Z to undo.",
    "사진을 그림 칸에 꼭 맞췄어요.": "Fitted the photo to the picture box.",
    "정렬하려면 사진이 두 장 이상 있어야 해요.": "Arranging needs at least two photos.",
    "사진 {n}장을 줄 맞춰 깔았어요. Ctrl+Z 로 되돌릴 수 있어요.": "Laid out {n} photos in rows. Press Ctrl+Z to undo.",
    "사진 {n}장을 격자로 깔았어요. Ctrl+Z 로 되돌릴 수 있어요.": "Laid out {n} photos in a grid. Press Ctrl+Z to undo.",
    "사진 {n}장을 사진첩처럼 깔았어요. Ctrl+Z 로 되돌릴 수 있어요.": "Laid out {n} photos like a photo album. Press Ctrl+Z to undo.",
    "사진 {n}장을 줄 맞춰 깔았어요 — 우클릭 '정렬해서 깔기' 로 격자·사진첩 모양으로 바꿀 수 있어요.":
      "Laid out {n} photos in rows — right-click and choose 'Arrange photos' for a grid or album look.",
    "겹친 것 가운데 {i}/{n} 을 골랐어요 — Alt+누르기로 아래 것을 골라요.": "Selected {i} of {n} overlapping stickers — Alt+click for the one below.",
    "스티커 하나를 골랐어요.": "Selected one sticker.",
    "이 날짜에만 적용": "Apply to this day only",
    ...
    "일기장 바탕": "Diary background",
    "내 그림": "My image",
    "바탕 그림 고르기": "Choose background image",
    "일기장 바탕에 넣을 그림 고르기": "Choose an image for the diary background",
    "일기장 바탕 그림 빼기": "Remove the diary background image",
    "바탕 그림 맞춤": "Diary background image fit",
    "일기장 바탕 그림 맞춤": "Diary background image fit",
    "바탕 흐리게": "Fade background",
    "일기장 바탕을 흐리게 하는 정도": "How much to soften the diary background",
    "일기장 바탕 그림을 넣는 중…": "Adding diary background image…",
    "여행일지 바탕": "Journal background",
    "여행일지 바탕에 넣을 그림 고르기": "Choose an image for the journal background",
    "여행일지 바탕 그림 빼기": "Remove the journal background image",
    "여행일지 바탕 그림 맞춤": "Journal background image fit",
    "여행일지 바탕을 흐리게 하는 정도": "How much to soften the journal background",
    "여행일지 바탕 그림을 넣는 중…": "Adding journal background image…",
    "인쇄할 땐 배경 빼기": "Leave the background out when printing",
    "배경 효과와 배경 그림을 빼고 인쇄해요(잉크를 아껴요). 일기장 전체에 적용돼요.": "Prints without the background effect and image, to save ink. Applies to the whole diary.",
    "효과 색·진하기": "Effect color and strength",
    "투명도": "Opacity",
    "스티커 투명도": "Sticker opacity",
    "사진 투명도": "Photo opacity",
    "사진 투명도 조절…": "Adjust photo opacity…",
    "다음에 붙일 스티커 투명도를 바꿨어요.": "Changed the opacity for the next sticker.",
    "배경 효과에 쓸 색": "Color used by the background effect",
    "배경 효과를 얼마나 진하게 할지": "How strong the background effect is",
    "배경 고르기": "Choose background",
    "배경으로 깔 그림 고르기": "Choose a background image",
    "그림 빼기": "Remove image",
    "배경 그림 빼기": "Remove the background image",
    "그림 맞춤": "Image fit",
    "배경 그림 맞춤": "Background image fit",
    "그림 흐리게": "Fade image",
    "배경 그림을 종이색으로 덮는 정도": "How much the paper color covers the background image",
    "붙인 사진 — 끌어서 옮기기, 두 번 누르면 크게 보기, Alt+누르기로 겹친 것 고르기, 우클릭으로 정렬·순서":
      "Photo sticker — drag to move, double-click to view large, Alt+click to pick an overlapped one, right-click to arrange and reorder",
    "크기 바꾸기": "Resize",
    "돌리기 (Shift: 15°씩)": "Rotate (Shift: 15° steps)",
    "사진 떼기": "Remove photo",
    "순서·돌리기·뒤집기": "Order, rotate, flip",
    "스티커": "Stickers",
    "달력·찾기 칸 감추기": "Hide the calendar panel",
    "달력·찾기 칸 보이기": "Show the calendar panel",
    "일기 목록 감추기": "Hide the entry list",
    "일기 목록 보이기": "Show the entry list",
    "제목·태그 줄 접기": "Fold the title and tag rows",
    "제목·태그 줄 펼치기": "Show the title and tag rows",
    "몰입 모드": "Focus mode",
    "몰입 모드 — 양옆을 감추고 종이만": "Focus mode — hide both side panels",
    "몰입 모드 나가기 (Esc)": "Leave focus mode (Esc)",
    "몰입 모드 — 날짜는 Alt+PageUp·PageDown, 나올 땐 Esc.": "Focus mode — Alt+PageUp/PageDown changes the day, Esc comes back.",
    "몰입 모드를 껐어요.": "Focus mode is off.",
    "스티커 붙이기 — 내장 그림과 글상자": "Add a sticker — built-in art and text boxes",
    "글상자": "Text box",
    "글상자 넣기": "Add a text box",
    "종이 위 아무 데나 글을 얹어요 — 두 번 누르면 고쳐 써요": "Drop text anywhere on the paper — double-click to edit",
    "글상자 글": "Text box content",
    "여기에 쓰세요": "Type here",
    "너비 바꾸기": "Change width",
    "스티커 떼기": "Remove sticker",
    "붙인 스티커 — 끌어서 옮기기, 모서리로 크기, 위 손잡이로 돌리기, 우클릭으로 순서·색": "Sticker — drag to move, corner to resize, top handle to rotate, right-click for order and color",
    "글상자 — 두 번 누르면 고쳐 쓰기, 끌어서 옮기기, 모서리로 너비, 우클릭으로 글자 크기·맞춤": "Text box — double-click to edit, drag to move, corner for width, right-click for size and alignment",
    "글 고쳐 쓰기": "Edit text",
    "글자 크기": "Text size",
    "글 맞춤": "Text alignment",
    "색 바꾸기": "Change color",
    "색을 먼저 고르면 그림도 글상자도 그 색으로 붙어요.": "Pick a color first and new art and text boxes use it.",
    "직접 고르기…": "Custom…",
    "다음에 붙일 스티커 색을 바꿨어요.": "Changed the color for the next sticker.",
    "고른 스티커 {n}개의 색을 바꿔요.": "Changes the color of {n} selected sticker(s).",
    "고른 사진 {n}장의 투명도를 바꿔요.": "Changes the opacity of {n} selected photo(s).",
    "{name} 스티커를 붙였어요 — 끌어서 옮기고 모서리로 크기를 바꿔요.": "Added a {name} sticker — drag to move, corner to resize.",
    "한 날에 스티커는 {max}개까지예요.": "A day can hold up to {max} stickers.",
    "글이 비어서 글상자를 뺐어요. Ctrl+Z 로 되돌릴 수 있어요.": "The text box was empty, so it was removed. Press Ctrl+Z to undo.",
    "스티커 {n}개": "{n} stickers",
    "스티커 {n}개 떼기": "Remove {n} stickers",
    "스티커 {n}개를 골랐어요 — 함께 옮기고 돌리고 뗄 수 있어요": "Selected {n} stickers — move, rotate and remove them together",
    "스티커 {n}개를 뗐어요. Ctrl+Z 로 되돌릴 수 있어요.": "Removed {n} stickers. Press Ctrl+Z to undo.",
    "스티커를 뗐어요. Ctrl+Z 로 되돌릴 수 있어요.": "Removed the sticker. Press Ctrl+Z to undo.",
    "맨 앞으로": "Bring to front",
    "한 칸 앞으로": "Bring forward",
    "한 칸 뒤로": "Send backward",
    "맨 뒤로": "Send to back",
    "왼쪽으로 15° 돌리기": "Rotate 15° left",
    "오른쪽으로 15° 돌리기": "Rotate 15° right",
    "돌리기 되돌리기": "Reset rotation",
    "그림 칸에 꼭 맞추기": "Fit to picture box",
    "사진을 뗐어요. Ctrl+Z 로 되돌릴 수 있어요.": "Removed the photo. Press Ctrl+Z to undo.",
    "사진을 붙이는 중…": "Adding photo…",
    "배경 그림을 넣는 중…": "Adding background image…",
    "그림을 읽지 못했어요.": "Couldn't read the image.",
    "일기장(.diary)을 읽지 못했어요. 파일이 손상됐을 수 있어요.": "Couldn't read the diary (.diary). The file may be damaged.",
    "일기장이 너무 커서 저장하지 못했어요(4GB 제한).": "The diary is too large to save (4 GB limit).",
    "인쇄 창의 '대상'에서 'PDF로 저장'을 고르면 PDF 파일이 됩니다": "Choose 'Save as PDF' as the destination in the print dialog to get a PDF file",
    "그리기": "Draw",
    "그림 칸에 그리기": "Draw in the picture box",
    "그림 전체 지우기": "Clear the drawing",
    "다 그렸어요": "Done",
    "원고지 칸": "Manuscript cells",
    "모두 고르기": "Select all photos",
    "손글씨 글꼴을 불러오지 못했어요.": "Couldn't load the handwriting font.",
    "그리기 끝내기 (Esc)": "Stop drawing (Esc)",
    "그림이 너무 많아 더 그릴 수 없어요.": "The drawing is too large to add more strokes.",
    "그림을 모두 지웠어요. Ctrl+Z 로 되돌릴 수 있어요.": "Cleared the drawing. Press Ctrl+Z to undo.",
    "제출본 일괄 검수 (.taskdone)": "Batch-review submissions (.taskdone)",
    "여러 파일 찾아 바꾸기": "Find and replace across files",
    "형식 변환 (JSON·CSV·표·마크다운)": "Convert format (JSON, CSV, table, Markdown)",
    // 환율 창 — 표·계산기·추이의 고정 문구(값과 통화 이름은 API 가 주는 대로 둔다)
    "환율 (고시환율·환율 계산)": "Exchange rates (official rates & converter)",
    "환율": "Exchange rates",
    "고시환율을 받아 표로 보고, 금액을 바꿔 보고, 며칠간의 추이를 칠판 그래프로 보냅니다. 받아 온 값은 이 컴퓨터에 저장해 두어 인터넷이 끊겨도 마지막 값을 계속 볼 수 있어요.":
      "Fetch official exchange rates as a table, convert amounts, and send a few days of history to the board as a graph. Fetched rates are stored on this computer so the last values stay readable offline.",
    "수출입은행 고시환율": "Korea Eximbank official rates",
    "ECB 참고환율": "ECB reference rates",
    "출처": "Source",
    "기준일": "As of",
    "다시 받기": "Fetch again",
    "방향 바꾸기": "Swap direction",
    "추이": "History",
    "칠판 그래프로": "Send to board graph",
    "CSV로 저장": "Save as CSV",
    "통화": "Currency",
    "단위": "Unit",
    "매매기준율": "Base rate",
    ...
    "송금 보낼 때": "Sending",
    "송금 받을 때": "Receiving",
    "통화 이름이나 코드로 거르기 (달러, USD …)": "Filter by currency name or code (dollar, USD, …)",
    "환율을 아직 받지 못했어요.": "No exchange rates fetched yet.",
    "그 이름의 통화가 없어요.": "No currency matches that name.",
    ...
    // 도구막대 아이콘화(⋯ 메뉴·확대 비율 칸)로 새로 생긴 글자들
    "글자 추출": "Extract text",
    "JPG로 저장": "Save as JPG",
    "PNG로 저장": "Save as PNG",
    "확대 비율": "Zoom level",
    "더 보기 — 다른 형식 저장·메모로·글자 추출·초기화": "More — save as another format, to notes, extract text, reset",
    ...
    "PowerPoint 변환에 실패해 간이 미리보기를 유지합니다.": "PowerPoint conversion failed; keeping the quick preview.",
    "PowerPoint 변환을 사용할 수 없어 간이 미리보기로 열어요.": "PowerPoint conversion unavailable; opening a simple preview.",
    "PowerPoint 변환을 사용할 수 없어 간이 미리보기를 유지합니다.": "PowerPoint conversion unavailable; keeping the quick preview.",
    "PowerPoint가 응답하지 않아 간이 미리보기를 유지합니다.": "PowerPoint did not respond; keeping the quick preview.",
    ...
    "PowerPoint 변환 백엔드를 사용할 수 없어 현재 간이 미리보기를 유지합니다.": "The PowerPoint conversion backend is unavailable; keeping the current quick preview.",
    "정확 변환은 ClassDock.exe에서 사용할 수 있습니다. 현재 간이 미리보기를 유지합니다.": "Exact conversion is available in ClassDock.exe. Keeping the current quick preview.",
    "PowerPoint 미리보기": "PowerPoint preview",
    "PowerPoint 파일을 열 때 자동으로 정확 변환": "Automatically use exact conversion when opening PowerPoint files",
    "설치된 PowerPoint로 PDF를 만들기 때문에 느릴 수 있습니다. 끄면 간이 미리보기로 바로 열고, 문서 위 버튼으로 필요할 때만 정확 변환합니다.": "This can be slow because it creates a PDF with installed PowerPoint. Turn it off to open a quick preview immediately and convert only when needed using the button above the document.",
    "빠르게 열기 위해 간이 PPTX 미리보기로 표시합니다. 복잡한 도형·차트·글꼴 배치는 원본과 다를 수 있습니다.": "Showing a quick PPTX preview for faster opening. Complex shapes, charts, and font layout may differ from the original.",
    "정확 변환에 실패해 간이 PPTX 미리보기로 열었습니다. 사유: ": "Exact conversion failed, so a quick PPTX preview was opened. Reason: ",
    "정확한 PDF로 열기": "Open as exact PDF",
    "정확 변환 중…": "Converting exactly…",
    "정확한 PDF 다시 열기": "Open exact PDF again",
    "정확 변환 다시 시도": "Retry exact conversion",
    ...
    "여기에 자바 코드를 작성하고 ▶ 실행": "Write Java code here and press ▶ Run",
    ...
    "재생 속도 — 느리게 들려주거나 빠르게 복습해요 ( [ 와 ] 키 )": "Playback speed — play it slower for listening or faster for review ( [ and ] keys )",
    "작은 창 끄기": "Exit mini window",
    "작은 창에서는 자막 크기 설정이 적용되지 않아요.": "The subtitle size setting doesn't apply in the mini window.",
    "작은 창으로 띄우지 못했어요.": "Couldn't open the mini window.",
    "영상만 작은 창으로 떼어 화면 위에 띄워요 — 다른 자료를 보면서 재생 (Alt+P)": "Pop the video out into a small always-on-top window — keep it playing while you use other materials (Alt+P)",
    "영상을 잠깐 재생한 뒤 작은 창으로 띄워 주세요.": "Play the video briefly, then open the mini window.",
    ...
    "보드 배경(색·무늬) 바꾸기": "Change the board background (color and pattern)",
    "보드 배경색 바꾸기": "Change the board background",
    "보드 배경색": "Board background",
    "배경색": "Background",
    "배경 고르기 닫기 (Esc)": "Close background picker (Esc)",
    ...
    "오선지": "Music staff",
    "원고지": "Manuscript grid",
    "새 보드 기본 무늬": "Default pattern for new boards",
    "배경 그림": "Background image",
    "고르기": "Choose",
    "바꾸기": "Replace",
    "배경으로 쓸 그림 파일 고르기": "Choose an image file for the background",
    "배경 그림 지우기": "Remove the background image",
    "지금 보이는 화면에 배경 그림을 다시 맞추기": "Re-fit the background image to the current view",
    "흐리기": "Fade",
    "배경 그림 흐리기": "Fade the background image",
    "채움": "Fill",
    "원본": "Actual size",
    "타일": "Tile",
    "타일로 놓기": "Tile across the board",
    "칸 크기": "Tile size",
    "타일 한 칸 크기": "Size of one tile",
    "배경으로": "To background",
    "선택한 그림을 보드 배경으로 내리기": "Send the selected image to the board background",
    "그림을 배경으로 내렸어요. 이제 판서에 걸리지 않아요.":
      "The image is now the background, so it no longer gets in the way of writing.",
    "배경으로 내리지 못했어요.": "Could not send it to the background.",
    "채움으로 놓기": "Place filling the view",
    "맞춤으로 놓기": "Place fitted in the view",
    "원본으로 놓기": "Place at actual size",
    "배경 그림을 넣었어요. 판서가 잘 보이게 '흐리기'로 연하게 만들 수 있어요.":
      "Background image added. Use Fade to lighten it so your writing stays readable.",
    "배경 그림을 지웠어요.": "Background image removed.",
    "배경 그림을 넣지 못했어요.": "Could not add the background image.",
    "그림 파일만 배경으로 쓸 수 있어요.": "Only image files can be used as a background.",
    "지금 화면에 맞췄어요.": "Fitted to the current view.",
    "내용이 커서 자동복원본을 남기지 못했어요. 탭을 닫기 전에 PNG 로 저장해 두세요.":
      "The board is too large to auto-save a recovery copy. Save it as PNG before closing the tab.",
    "자동 무늬": "Automatic pattern color",
    "먹색 무늬": "Ink-colored pattern",
    "파랑 무늬": "Blue pattern",
    "빨강 무늬": "Red pattern",
    "초록 무늬": "Green pattern",
    "흰색 무늬": "White pattern",
    ...
    "연대표": "Timeline",
    "연표": "Timeline",
    "연대표 만들기": "Timeline editor",
    "연대표 제목": "Timeline title",
    "문서 용도": "Document purpose",
    "일반 연대표": "General timeline",
    "여행 일정": "Travel itinerary",
    "여행 제목": "Trip title",
    "＋ 일정": "+ Itinerary item",
    "새 여행 일정 추가": "Add a travel itinerary item",
    "같은 시작 시각에서 앞 일정으로 이동": "Move earlier among items with the same start time",
    ...
    "제목·유형·장소·메모 검색": "Search title, type, place, or notes",
    "첫 일정을 넣어 여행계획을 시작하세요": "Add the first item to start your trip plan",
    "날짜와 시각, 장소, 메모, 사진을 넣을 수 있습니다.": "Add a date and time, place, notes, and photo.",
    "＋ 첫 일정 추가": "+ Add first item",
    "▶ 일정 보기": "▶ View itinerary",
    "일정을 시간순으로 하나씩 크게 보여주기": "Show itinerary items one at a time in chronological order",
    "일정 목록을 CSV 또는 Excel로 저장": "Save the itinerary as CSV or Excel",
    "일정 목록을 UTF-8 CSV로 저장": "Save the itinerary as a UTF-8 CSV file",
    "사진을 포함한 일정 목록을 Excel 파일로 저장": "Save the itinerary and photos as an Excel file",
    "CSV·엑셀(.xlsx)에서 일정 가져오기": "Import itinerary items from CSV or Excel (.xlsx)",
    "모든 일정을 한 화면에서 보기": "Show all itinerary items on one screen",
    "개 일정 · 점을 누르면 상세 카드로 이동합니다": " items · Select a dot to open its detail card",
    "제목 없는 일정": "Untitled itinerary item",
    "아직 일정이 없습니다.": "No itinerary items yet.",
    "일정 고치기": "Edit itinerary item",
    "새 일정 추가": "Add itinerary item",
    "예: 2026-08-21 09:30": "e.g. 2026-08-21 09:30",
    "예: 2026-08-21 11:00": "e.g. 2026-08-21 11:00",
    "예: 이동·관광·식사·숙박": "e.g. Transit, sightseeing, dining, lodging",
    "장소(선택)": "Place (optional)",
    "장소 주소(선택)": "Place address (optional)",
    "시작을 ‘2026-08-21 09:30’처럼 입력하세요.": "Enter the start like ‘2026-08-21 09:30’.",
    "종료 날짜·시각 형식을 확인하세요.": "Check the end date and time format.",
    "종료는 시작보다 빠를 수 없습니다.": "The end can't be earlier than the start.",
    "지도에서 장소를 찾지 못했어요.": "Couldn't find the place on the map.",
    "보여줄 일정이 없습니다.": "There are no itinerary items to show.",
    "일정 {count}개를 가져왔어요.": "Imported {count} itinerary items.",
    "여행 일정에는 항목을 최대 1,000개까지 넣을 수 있어요.": "A travel itinerary can contain up to 1,000 items.",
    "{source}에서 일정을 읽지 못했어요.": "Couldn't read itinerary items from the {source}.",
    "새 사건 또는 기간 추가": "Add an event or period",
    "읽기 좋게 균등": "Even spacing for readability",
    "시간 간격대로": "Proportional to time",
    "사건 사이 간격": "Event spacing",
    "연대표 축소": "Zoom out timeline",
    "연대표 확대": "Zoom in timeline",
    "연대표 배율 100%로 초기화": "Reset timeline zoom to 100%",
    "☷ 목록": "☷ List",
    "사건 목록 열기·닫기": "Open or close the event list",
    "표에서 사건 가져오기": "Import events from a table",
    "사건 목록을 CSV로 저장": "Save the event list as CSV",
    "표 내보내기": "Export table",
    "사건 목록을 CSV 또는 Excel로 저장": "Save the event list as CSV or Excel",
    "사건 목록을 UTF-8 CSV로 저장": "Save the event list as a UTF-8 CSV file",
    "사진을 포함한 사건 목록을 Excel 파일로 저장": "Save the event list and photos as an Excel file",
    "Excel 만드는 중…": "Creating Excel…",
    "엑셀을 만들 준비가 안 됐어요. 잠시 뒤 다시 시도해 주세요.": "Excel export isn't ready. Please try again in a moment.",
    "Excel 파일을 만들지 못했어요.": "Couldn't create the Excel file.",
    "Excel로 내보냈어요. 사진 {count}장 포함": "Exported to Excel with {count} photos",
    "Excel로 내보냈어요. 사진 {count}장은 넣지 못했습니다.": "Exported to Excel, but couldn't include {count} photos.",
    "▶ 발표": "▶ Present",
    "이미지 폴더": "Image folder",
    ...
    "연대표 저장 (Ctrl+S)": "Save timeline (Ctrl+S)",
    "연대표 화면": "Timeline canvas",
    "사건 목록": "Event list",
    "사건 목록 닫기": "Close event list",
    "제목·분류·설명 검색": "Search title, category, or description",
    "첫 사건을 넣어 연대표를 시작하세요": "Add the first event to start your timeline",
    "연도·날짜와 설명, 사진을 넣을 수 있습니다. 기원전은 ‘기원전 300’처럼 적으세요.":
      "Add a year/date, description, and photo. For BCE dates, enter something like ‘BC 300’.",
    "＋ 첫 사건 추가": "＋ Add first event",
    "제목 없는 사건": "Untitled event",
    "검색 결과가 없습니다.": "No search results.",
    "아직 사건이 없습니다.": "No events yet.",
    "사건 고치기": "Edit event",
    "새 사건 추가": "Add event",
    "종료(선택)": "End (optional)",
    "기간이면 끝 날짜": "End date for a period",
    "예: 정치·문화·과학": "e.g. Politics, culture, science",
    "사진 없음": "No photo",
    "사진 넣기": "Add photo",
    "사진 지우기": "Remove photo",
    ...
    "종료 날짜 형식을 확인하세요.": "Check the end-date format.",
    ...
    "로드뷰": "Street view",
    "로드뷰 창 닫기": "Close street view",
    "카카오맵 상세 보기 창 닫기": "Close Kakao Map details",
    "카카오맵 로드뷰를 불러오는 중…": "Loading Kakao Map street view…",
    "로드뷰가 안 보이거나 화면이 비어 있으면 '브라우저로 보기'를 눌러 주세요.": "If street view doesn't show or the screen is blank, press 'Open in browser'.",
    "같은 자리 로드뷰를 브라우저 창에서 열어요": "Open street view of the same spot in a browser window",
    "내용이 안 보이거나 눌러 들어간 화면이 비어 있으면 '브라우저로 보기'를 눌러 주세요.": "If nothing shows or an opened page is blank, press 'Open in browser'.",
    "이 장소의 카카오맵 상세 페이지를 브라우저 창에서 열어요": "Open this place's Kakao Map page in a browser window",
    ...
    "2026년 7월 (최신)": "July 2026 (latest)",
    "2025년 12월 (광주·전남 통합 전)": "Dec 2025 (before Gwangju–Jeonnam merger)",
    "2026년 7월": "July 2026",
    "2025년 12월": "Dec 2025",
    "행정구역 2026년 7월": "Boundaries July 2026",
    "행정구역 2025년 12월": "Boundaries Dec 2025",
    "통계청 SGIS": "Statistics Korea SGIS",
    " 표에서 (붙여넣기·CSV·엑셀)": " From a table (paste · CSV · Excel)",
    " 지도에 찍은 표시 개수": " Number of pins on the map",
    "CSV·엑셀 파일 고르기": "Choose CSV or Excel file",
    "값 열": "Value column",
    "제목": "Title",
    "단계": "Classes",
    "나누기": "Breaks",
    "같은 개수씩": "Quantile",
    "같은 간격": "Equal interval",
    "옅게": "Light",
    "보통": "Medium",
    "진하게": "Strong",
    "주황": "Orange",
    ...
    "파일을 읽지 못했어요.": "Couldn't read the file.",
    "CSV 파일은 5MB 이하로 골라 주세요.": "Choose a CSV file of 5MB or less.",
    "표시 {total}개 중 {inside}개가 지역 안에 있어요 — 표시를 옮기거나 더하면 색이 따라 바뀝니다.":
      "{inside} of {total} pins are inside a region — shading follows when you move or add pins.",
    "맞춘 지역 {count}곳": "{count} regions matched",
    "{label} 기준": "as of {label}",
    "이름을 못 찾음 {count}개: {names}": "{count} names not found: {names}",
    "여러 곳과 겹침 {count}개: {names} — 시도 이름을 함께 적어 주세요": "{count} ambiguous: {names} — add the province name",
    "값이 빈 줄 {count}개": "{count} rows without a value",
    ...
    "직선 거리와 자동차 경로를 비교하고 우선순위·회피·차량 옵션을 설정합니다 (표시 7개까지)":
      "Compare straight-line and driving distances and set routing, avoidance, and vehicle options (up to 7 pins)",
    "경로 기준": "Route preference",
    "추천 경로": "Recommended",
    "최단 시간": "Fastest",
    "최단 거리": "Shortest",
    "차량 유종": "Fuel type",
    ...
    "유료 도로": "Toll roads",
    "자동차 전용 도로": "Motorways",
    "어린이 보호 구역": "School zones",
    "유턴": "U-turns",
    "하이패스 장착": "Hi-pass installed",
    "대안 경로 함께 비교": "Compare alternative routes",
    "출발·도착 순서 뒤집기": "Reverse start and destination",
    "경유지 순서 자동 최적화": "Automatically optimize waypoint order",
    "직선 거리도 함께 표시": "Also show straight-line distance",
    "길찾기 비교": "Route comparison",
    "구간": "Segment",
    "예상 시간": "Estimated time",
    "길찾기 끄기": "Turn off routing",
    "경로를 도형으로 저장": "Save route as a shape",
    "적용·길찾기": "Apply & route",
    "교통 상태": "Traffic",
    "교통 정보 없음": "No traffic data",
    "정체": "Heavy traffic",
    "지체": "Delayed",
    "서행": "Slow",
    "원활": "Smooth",
    "사고·통행 불가": "Accident / impassable",
    "순서별 주행 안내": "Turn-by-turn directions",
    "이름 없는 도로": "Unnamed road",
    "주행 안내": "Driving direction",
    "이동": "Continue",
    "표시가 두 개 이상 있어야 길을 찾을 수 있습니다.": "At least two pins are needed to find a route.",
    "설정을 바꾼 뒤 적용·길찾기를 누르면 비교 결과가 갱신됩니다.":
      "Change the settings and select Apply & route to refresh the comparison.",
    "설정을 고른 뒤 적용·길찾기를 눌러 주세요.": "Choose settings, then select Apply & route.",
    "{start} → {end} · 경유지 {count}개": "{start} → {end} · {count} waypoints",
    "직선 연결 거리 {distance}": "Straight-line distance {distance}",
    "경로 {index} · {distance} · {duration} · 직선보다 +{extra} ({ratio}%) · 통행료 {toll}원 · 택시 예상 {taxi}원":
      "Route {index} · {distance} · {duration} · +{extra} vs straight line ({ratio}%) · toll ₩{toll} · est. taxi ₩{taxi}",
    "대안 {index} · {distance} · {duration}": "Alternative {index} · {distance} · {duration}",
    "{index}. {guidance} · {distance} · {duration}": "{index}. {guidance} · {distance} · {duration}",
    "{road} · {state} · {speed}km/h · {distance}": "{road} · {state} · {speed} km/h · {distance}",
    "자동차 경로 · {distance} · {duration}": "Driving route · {distance} · {duration}",
    "현재 자동차 경로를 일반 도형으로 저장했습니다 — 이제 지도 자료 내보내기에서 GPX로 저장할 수 있습니다.":
      "Saved the current driving route as a regular shape — you can now export it as GPX from Export map data.",
    ...
    "자동차 길찾기는 표시 {max}개까지 한 번에 이어요 — 지금 보이는 {count}개 가운데 설정한 순서의 {max}개만 길을 찾았습니다(경유지 상한).":
      "Driving routes cover up to {max} pins at once — only the first {max} in the selected order were routed (waypoint limit; {count} pins shown).",
    ...
    "첫 줄에 지도용 위도·경도(또는 X·Y 좌표)/주소 열 또는 연대표용 시작·제목 열이 필요합니다. [표 양식]으로 모양을 확인하세요.":
      "The first row needs map latitude/longitude (or X/Y coordinate) or address columns, or timeline Start and Title columns. Use [Table template] to see the layout.",
    // 카카오모빌리티: 다중 경유지·출발 시각·여러 곳까지 비교
    "{time} 출발 예상": "Departing {time} (forecast)",
    "출발 시각을 정한 길찾기는 표시 {max}개까지 한 번에 이어요 — 지금 보이는 {count}개 가운데 설정한 순서의 {max}개만 길을 찾았습니다.": "Directions with a set departure time connect up to {max} markers at once — only the first {max} of the {count} visible markers, in the chosen order, were routed.",
    "{origin}에서 다른 표시 {count}곳까지 차로 걸리는 거리·시간을 한 번에 비교해요(직선 10km 안, 최대 30곳).": "Compare driving distance and time from {origin} to {count} other markers at once (within 10 km straight-line, up to 30).",
    "비교 {count}줄을 메모 표로 보냈어요.": "Sent {count} comparison rows to a notes table.",
    "표시가 두 개 이상 있어야 비교할 수 있어요.": "You need at least two markers to compare.",
    "비교하는 중…": "Comparing…",
    "반경(10km) 밖": "Beyond 10 km",
    "길 없음": "No route",
    "비교 결과를 받아오지 못했어요 — 인터넷 연결을 확인하고 다시 눌러 주세요.": "Could not get the comparison — check the internet connection and try again.",
    "다시 비교": "Compare again",
    "출발": "From",
    "도착": "To",
    "직선 거리(m)": "Straight-line distance (m)",
    "차로 거리(m)": "Driving distance (m)",
    "예상 시간(분)": "Estimated time (min)",
    "출발 시각은 지금보다 뒤로 정해 주세요.": "Set a departure time later than now.",
    "출발 시각": "Departure time",
    "지금 출발": "Leave now",
    "정해서 출발": "Leave at",
    "정한 시각의 예상 교통으로 길을 찾아요. 이때는 표시 7개까지 이을 수 있어요.": "Routes use forecast traffic for that time. Up to 7 markers can be connected.",
    "여러 곳까지 비교": "Compare to several places",
    "첫 표시에서 나머지까지 비교": "Compare from the first marker to the rest",
    "직선": "Straight line",
    "차로 거리": "Driving distance",
    "메모 표로 보내기": "Send to notes table",
    // 평면 좌표 → 위경도(표 들이기)
    "평면 좌표를 위경도로 바꾸기": "Convert projected coordinates to latitude/longitude",
    "좌표계": "Coordinate system",
    "X·Y 열을 바꿔 읽기": "Swap the X and Y columns",
    "바꾼 위치": "Converted location",
    "표시 넣기": "Add markers",
    "표시 {count}개 넣기": "Add {count} markers",
    "바꿀 수 없음": "Cannot convert",
    "대한민국 밖": "Outside South Korea",
    "{lat}, {lng} (경계 밖·바다)": "{lat}, {lng} (outside boundaries or at sea)",
    "{count}줄 중 {inside}줄이 대한민국 안에 떨어져요.": "{inside} of {count} rows fall inside South Korea.",
    "값 범위로 짐작했어요 — 아래 위치가 맞는지 확인해 주세요.": "Guessed from the value ranges — check that the locations below are right.",
    "주소 열과 맞춰 골랐어요 — {total}줄 중 {count}줄이 주소와 같은 시군구예요.": "Chosen by matching the address column — {count} of {total} rows fall in the same district as their address.",
    "표의 {count}줄이 위도·경도가 아니라 평면 좌표(미터)예요. 자료가 쓰는 좌표계를 고르면 앱 안에서 바꿔 표시로 넣어요(인터넷·인증키가 필요 없어요).": "{count} rows in the table use projected coordinates (meters), not latitude/longitude. Choose the data's coordinate system and they are converted in the app and added as markers (no internet or key needed).",
    "평면 좌표 {count}줄을 {system}로 바꿔 표시로 넣었습니다": "Converted {count} projected rows from {system} and added them as markers",
    " · 대한민국 밖 {dropped}줄 제외": " · {dropped} rows outside South Korea skipped",
    "도로명주소·국가공간정보": "Road-name addresses, national spatial data",
    "국토부·지자체 공간정보(가산 60만)": "MOLIT and local government spatial data (false northing 600,000)",
    "카카오·다음 지도(가산 50만)": "Kakao and Daum maps (false northing 500,000)",
    "지방행정 인허가(LOCALDATA) 자료": "Local licensing data (LOCALDATA)",
    "옛 지적·도시계획 자료": "Older cadastral and urban planning data",
    "서해안 지역(가산 60만)": "West coast (false northing 600,000)",
    "동해안 지역(가산 60만)": "East coast (false northing 600,000)",
    "울릉도·독도(가산 60만)": "Ulleungdo and Dokdo (false northing 600,000)",
    "GPS·해외 지도 프로그램": "GPS and international map software",
    "카카오맵 링크·주소창": "Kakao Map links and address bar",
  ...
  var HTML_DICT = {
    ...
    "welcome.step3": "<span class=\"welcome-step-ico\">💾</span><div><b>3. Check save status</b><small>The badge beside the file name combines the original/copy destination with its save status. Save buttons are always labeled <b>Save</b>.</small></div>",
  ...
  var PARAMS = {
    ...
    "사진 {n}장": "{n} {n|photo|photos}",
    "이번 달 일기 {n}편": "{n} {n|entry|entries} this month",
    ...
    "사진 {n}장을 골랐어요 — 함께 옮기고 돌리고 뗄 수 있어요": "{n} {n|photo|photos} selected — move, rotate or remove them together",
    "사진 {n}장 떼기": "Remove {n} {n|photo|photos}",
    "사진 {n}장을 뗐어요. Ctrl+Z 로 되돌릴 수 있어요.": "Removed {n} {n|photo|photos}. Press Ctrl+Z to undo.",
    ...
    "자바 내려받는 중… {received} / {total} MB": "Downloading Java… {received} / {total} MB",
    "이 문서에 라이브러리 {count}개 적용 중": "{count} libraries applied to this document",
    "한 번에 {max}개까지 고를 수 있어요.": "You can select up to {max} at a time.",
    "{name} 를 이 컴퓨터에서 지우기": "Remove {name} from this computer",
    "목록을 읽지 못했어요: {message}": "Could not read the list: {message}",
    "{name} 받는 중": "Downloading {name}",
    "{name} 를 받아 이 문서에 적용했어요.": "Downloaded {name} and applied it to this document.",
    "{name} 를 이 문서에 적용했어요.": "Applied {name} to this document.",
    "최신 {version} · 직접 의존성 {count}개": "Latest {version} · {count} direct dependencies",
    "최신 {version} · 의존성 정보는 확인하지 못했어요.": "Latest {version} · dependency information unavailable",
    "검색 결과를 준비하지 못했어요: {message}": "Could not prepare the search result: {message}",
    "검색 결과 {count}개 · ★는 ClassDock 추천 항목입니다.": "{count} results · ★ marks a ClassDock-recommended item.",
    "검색하지 못했어요: {message}": "Could not search: {message}",
    "직접 의존성 {count}개가 있습니다. 이 화면은 딸린 라이브러리를 자동으로 받지 않으므로 추가 설치가 필요할 수 있어요.":
      "This library has {count} direct dependencies. This screen does not download them automatically, so additional installation may be required.",
    "‘{name}’ 를 이 컴퓨터에서 지울까요?": "Remove '{name}' from this computer?",
    "Maven Central에서 ‘{name}’ 라이브러리(jar)를 내려받아 이 컴퓨터에 보관합니다.\n\n받은 파일은 배포처가 알려준 검증값과 대조합니다. 이 코드는 실행할 때 함께 동작하니 믿을 수 있는 것만 받으세요.":
      "Downloads the '{name}' library (jar) from Maven Central and keeps it on this computer.\n\nThe download is checked against the publisher's checksum. This code runs alongside yours, so only get libraries you trust.",
    "설치 중… {percent}%": "Installing… {percent}%",
    "{version} · 준비됐습니다. 이어서 실행합니다…": "{version} · Ready. Continuing your run…",
    "Eclipse Adoptium 공식 배포처에서 자바(JDK {version})를 약 200MB 내려받아 설치합니다.\n이 컴퓨터에서 한 번만 하면 되고, 관리자 권한은 필요하지 않습니다.":
      "About 200 MB will be downloaded from the official Eclipse Adoptium distribution to install Java (JDK {version}).\nThis is needed only once on this computer and does not require administrator access.",
    "자동 설치에 실패했어요 ({message}). 인터넷이 안 되는 컴퓨터라면 다른 곳에서 JDK를 받아 풀어 두고 '다시 검사'를 눌러도 됩니다.":
      "Automatic installation failed ({message}). If this computer is offline, extract a JDK downloaded elsewhere and select 'Scan again'.",
    "입력을 전달하지 못했어요: {message}": "Couldn't send the input: {message}",
    "…(출력이 {length}자로 길어 중간을 생략했어요)…": "…(output is {length} characters long; the middle was omitted)…",
    "실행 결과 · 종료 코드 {code}": "Run output · exit code {code}",
    "⏱ {seconds}초가 넘도록 끝나지 않았어요. 끝나지 않는 반복이 없는지 확인해 주세요.":
      "⏱ The run did not finish within {seconds} seconds. Check for an infinite loop.",
    "프로그램이 비정상 종료되었습니다 (종료 코드 {code}).": "The program exited abnormally (exit code {code}).",
    "테스트 {index}": "Test {index}",
    "채점 중… {index}/{total}": "Grading… {index}/{total}",
