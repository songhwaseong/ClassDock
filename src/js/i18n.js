...
(function () {
  ...
  var DICT = {
    ...
    "설정의 '버스 실시간'에 공공데이터포털 인증키를 넣어 주세요.": "Enter a data.go.kr service key under 'Live buses' in Settings.",
    ...
    "인증키가 없어 지도의 '버스'를 쓸 수 없습니다.": "Without a key, 'Buses' on the map is unavailable.",
    "버스 인증키가 이 Windows 사용자 계정에 암호화되어 있습니다.": "The bus key is stored encrypted for this Windows user.",
    "버스 인증키를 이번 실행 동안 기억하고 있습니다.": "The bus key is kept for this session only.",
    "버스 키 설정은 ClassDock.exe에서 사용할 수 있습니다.": "Bus key settings are available in ClassDock.exe.",
    "저장할 공공데이터포털 인증키를 입력해 주세요.": "Enter the data.go.kr service key to save.",
    "TAGO 연결을 시험하는 중…": "Testing the TAGO connection…",
    "TAGO 연결에 성공했고 키를 저장했습니다.": "Connected to TAGO and saved the key.",
    "오늘 조회 한도를 다 쓴 키입니다. 내일 다시 시험해 주세요.": "This key has used up today's quota. Test again tomorrow.",
    "TAGO에 연결하지 못했습니다. 인터넷 연결을 확인하고 다시 시험해 주세요.": "Could not reach TAGO. Check the internet connection and test again.",
    "인증키를 확인하지 못했습니다. 공공데이터포털에서 TAGO 버스노선정보를 활용신청한 키인지 확인해 주세요. 신청 직후에는 반영까지 시간이 걸릴 수 있습니다.": "The key could not be verified. Make sure it is approved for TAGO bus route information on data.go.kr. New approvals can take a while to take effect.",
    "버스 인증키를 지웠습니다.": "Removed the bus key.",
