...
const MNDocumentTypes = (() => {
  ...
  const ZIP_OPENABLE = ["pdf","docx","doc","xlsx","xls","csv","pptx","hwp","hwpx","md","markdown","mdx","txt","html","htm","xhtml","ipynb","map","timeline","concept","study","mnote","diary","trip","msheet","musicxml","mxl",
