...
const TOGGLEABLE_TOOLS = Object.freeze([
  ...
  { id:"imgRotate",   label:"회전(왼쪽·오른쪽)",cls:"img-tool-rotate",     target:"image" },
  ...
  { id:"imgZoom",     label:"확대·축소(비율 칸 포함)",cls:"img-tool-zoom", target:"image" },
  ...
  { id:"mapGeoExport", label:"지도 자료 내보내기", cls:"map-toolvis-geo-export", target:"map" },
